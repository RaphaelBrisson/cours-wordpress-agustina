<!-- <footer class="content-info">
 ...
 <footer id="contact" class="wrap">
    ...
    <div class="contact-data">
      <div>
        <div>
          <img src="<?= App\asset_path('images/mail.png'); ?>" width="31" alt="mail">
          <img src="<?= App\asset_path('images/phone.png'); ?>" width="28" alt="phone">
          <img src="<?= App\asset_path('images/position.png'); ?>" width="24" alt="gps_position">
        </div>
        <div>
